...
@bot.on(man_cmd(outgoing=True, pattern=r"something(?: |$)(.*)"))
async def _(typew):
    sleep(1)
    await typew.edit("`PRASTI♡")
    sleep(1)
    await typew.edit("`AKU SAYANG KAMU`")
    sleep(1)
    await typew.edit("`SAYANG BANGET SAMA KAMU`")
    sleep(1)
    await typew.edit("`JANGAN BERUBAH YA`")
    sleep(1)
    await typew.edit("`TETEP JADI GEMOI NYA AKU`")
    sleep(1)
    await typew.edit("`I LOVEE YOU`")
    sleep(1)
    await typew.edit("`JAN NINGGALIN AKU`")
    sleep(1)
    await typew.edit("`AKU PEN SAMA KAMU`")
    sleep(1)
    await typew.edit("`I LOVEE YOUUUU`")
    sleep(1)
    await typew.edit("`sayang prasti♡`")
